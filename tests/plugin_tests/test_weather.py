...
def wrap_result(func, event, results=None):
    ...
    with patch.object(event.conn, "notice", notice), patch.object(
        event.conn, "message", message
...
@pytest.mark.parametrize("mph,kph", [(0, 0), (20, 32.18688), (43, 69.201792),])
